  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-content">
        <div onClick={goDashboard} className={`divX ${active===0 ?"active-div":""}`}>
          <MdOutlineGridView className="sidebar-icon" />
          <a href="">Dashboard</a>
        </div>
        <div onClick={addItem} className={`divX ${active===1 ?"active-div":""}`}>
          <MdOutlineAddBox className="sidebar-icon" />

          <a href="">Add Item</a>
        </div>
        <div className={`divX ${active===2 ?"active-div":""}`} onClick={goSetting}>
